...
class SafeIO
{
    ...
    public static function open($path)
    {
        ...
        if ($fo === false)
        {
            throw new Exception("Error while opening the file " + $path);
        }
        ...
        {
            throw new Exception("Error while trying to get lock at " + $path);
        }
    }
    ...
    public static function save($content, $path, $reset = true)
    {
        ...
        {
            throw new Exception("File not writable at " + $path);
        }
        ...
        if (flock($fp, LOCK_EX))
        {
            ...
            if (fputs($fp, $content) === false)
                throw new Exception("Error while saving contents at " + $path);
